...
public class Mats {
	...
	public static final NTMMaterial MAT_IRON			= makeSmeltable(2600,		IRON,		0xFFFFFF, 0x353535, 0xFFA259).setShapes(CASTPLATE);
	...
	public static final NTMMaterial MAT_SUPER		= makeSmeltable(_AS + 15, SUPER,	0xAE83AB, 0x372835, 0xAE5E52).setShapes(WIRE, INGOT, CASTPLATE);
