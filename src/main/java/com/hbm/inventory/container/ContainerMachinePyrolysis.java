...
public class ContainerMachinePyrolysis extends Container {

    private TileEntityMachinePyrolysis pyrolysis;

    public ContainerMachinePyrolysis(InventoryPlayer invPlayer, TileEntityMachinePyrolysis tedf) {
    ...
    public boolean canInteractWith(EntityPlayer player) {
        return pyrolysis.isUseableByPlayer(player);
    }
}
