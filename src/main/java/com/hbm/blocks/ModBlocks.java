...
public class ModBlocks {
	...
	public static Block pyrolysis_oven;
	...
	private static void initializeBlock() {
		...
		pyrolysis_oven = new MachinePyrolysis(Material.iron).setBlockName("pyrolysis_oven").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":block_steel");
