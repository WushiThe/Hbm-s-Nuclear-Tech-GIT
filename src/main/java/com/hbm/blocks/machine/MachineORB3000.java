...
import com.hbm.tileentity.machine.storage.TileEntityMachineORB3000;
...
public class MachineORB3000 extends BlockDummyable implements IPersistentInfoProvider {

	public MachineORB3000(Material mat) {
		super(mat);
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		...
		if(meta >= 12) return new TileEntityMachineORB3000();
	...
	public int getComparatorInputOverride(World world, int x, int y, int z, int side) {
		...
		if(!(te instanceof TileEntityMachineORB3000))
			return 0;

		TileEntityMachineORB3000 tank = (TileEntityMachineORB3000) te;
