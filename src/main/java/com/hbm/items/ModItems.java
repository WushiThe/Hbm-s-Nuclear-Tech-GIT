...
public class ModItems {
	...
	public static Item powder_morphine;
	...
	public static void initializeItem() {
		...
		rbmk_fuel_gravity = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_gravity)
				.setYield(100000000D)
				.setStats(70, 20)
				.setFunction(EnumBurnFunc.ARCH)
				.setDepletionFunction(EnumDepleteFunc.LINEAR)
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(powder_morphine, powder_morphine.getUnlocalizedName());
