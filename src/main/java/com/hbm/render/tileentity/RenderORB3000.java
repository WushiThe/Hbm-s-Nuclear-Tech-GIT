...
public class RenderORB3000 extends TileEntitySpecialRenderer {

	@Override
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float interp) {

		TileEntityMachineORB3000 bat = (TileEntityMachineORB3000) te;
		...
		bindTexture(ResourceManager.orb3000_tex);

		GL11.glShadeModel(GL11.GL_SMOOTH);
		ResourceManager.orb3000.renderAll();
