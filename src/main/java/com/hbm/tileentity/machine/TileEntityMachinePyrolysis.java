...
import com.hbm.inventory.gui.GUIMachinePyrolysis;
...
public class TileEntityMachinePyrolysis extends TileEntityMachineBase implements IEnergyReceiverMK2, IFluidStandardTransceiver, IPersistentNBT, IGUIProvider {
    ...
    public TileEntityMachinePyrolysis() {
        super(11);
    ...
    public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new ContainerMachinePyrolysis(player.inventory, this);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new GUIMachinePyrolysis(player.inventory, this);
    }
}
